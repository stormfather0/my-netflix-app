    ...
    <div className="home">
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          ...
          <p>
            Discovering his ties to a secret ancient order, a young man is drawn
            into a dangerous world of power, corruption and mystery
          </p>
          <div className="hero-btns">
            <button className="btn" onClick={() => setPlayTitleVideo(true)}>
              Play
      ...
      {moreInfo && (
        <div className="more-info">
          <span onClick={() => setMoreInfo(false)} className="close">
            {" "}
            &times;
          </span>
          <div>
          ...
          <div>Starring: Çağatay Ulusoy, Ayça Ayşin Turan, Hazar Ergüçlü</div>
        </div>
      )}
      ...
      <div className="get-started">
        <div className="get-started-text">
          ...
          <h2 className="get-started-subtitle">
            Starts at EUR 4.99. Cancel anytime.
          </h2>
          <h3 className="get-started-description">
      ...
      <section>
        ...
        <div className="join-us">
          <div className="join-us-block">
            <h1 className="join-us-header">Enjoy on your TV</h1>
          ...
          <div className="join-us-block">
            <h1 className="join-us-header">Watch everywhere</h1>
            <p className="join-us-description">
          ...
          <div className="join-us-block">
            <h1 className="join-us-header">Create profiles for kids</h1>
            <p className="join-us-description">
